...
public class Ventana extends JFrame {
	...
	public void setEstado(int estado) {
		if(estado == 1) {
			...
			sup.setEtiquetaSinIcono(" ESTADO: MIXTO");
		}
	}

	public void setEstadoPendiente(String texto) {
		sup.setEtiquetaSinIcono(texto);
	}

	public void setBotonesHabilitados(boolean habilitado) {
		btnStart.setEnabled(habilitado);
		btnStop.setEnabled(habilitado);
	}
}
